<template>
  <div
    class="TfTechSpec bground1 pt-5 mt-5 container-fluid"
    v-if="state.transformer.affiliation === true"
  >
    <div class="row bg-warning border border-danger m-3 mb-5 pb-5">
      ...
      <img class="m-3" :src="state.transformers.imgURL" />
      <div class="col p-3 pb-5 mx-3">
  ...
  <div
    class="TfTechSpec bground2 text-primary pt-5 mt-5 container-fluid"
    v-else
  >
    <div class="row bg-secondary border m-5 mb-5 pb-5">
      <div class="col p-3 mx-3">
        <h1>
          <span>{{ state.transformer.name }}</span>
        </h1>
